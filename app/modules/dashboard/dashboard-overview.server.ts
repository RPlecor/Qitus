...
export class DashboardOverview {
  async getOverview(input: string | CompanyWorkspace, _options: { includeComparison?: boolean } = {}): Promise<DashboardOverviewResult> {
    ...
    const [accountingReview, freshness, closingAdjustments, coverage, comparison] = typeof input === "string"
    ...
    return {
      ...
      alerts: buildDashboardAlerts(reviewCount, importCount, documents.map((document) => document.type), accountingReview, {

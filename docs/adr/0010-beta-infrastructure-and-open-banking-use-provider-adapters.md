...
Paperasse beta is production-shaped without becoming a regulated banking connector itself.
...
- Paperasse stores provider connection ids, consent status and masked account metadata, never raw bank credentials.
